#!/usr/bin/env python3
"""Evaluate all decoder checkpoints in out/decoder/All_Beauty/image/ on both
...
Usage
-----
  python3 eval_image.py

  # Override defaults:
  python3 eval_image.py \\
      --checkpoint_dir out/decoder/All_Beauty/image \\
      --rqvae_dir      out/rqvae/ \\
      --category       All_Beauty \\
      --output_file    out/eval_image_results.json \\
      --device         cuda
"""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate all image decoder checkpoints.")
    parser.add_argument("--checkpoint_dir", default="out/decoder/All_Beauty/image")
