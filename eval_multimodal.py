#!/usr/bin/env python3
"""Evaluate all decoder checkpoints in out/decoder/All_Beauty/multimodal/ on both
...
Usage
-----
  python3 eval_multimodal.py

  # Override defaults:
  python3 eval_multimodal.py \\
      --checkpoint_dir out/decoder/All_Beauty/multimodal \\
      --rqvae_dir      out/rqvae/ \\
      --category       All_Beauty \\
      --output_file    out/eval_multimodal_results.json \\
      --device         cuda
"""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate all multimodal decoder checkpoints.")
    parser.add_argument("--checkpoint_dir", default="out/decoder/All_Beauty/multimodal")
